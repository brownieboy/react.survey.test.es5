...
/***/ function(module, exports, __webpack_require__) {
	...
	var CheckboxInput = __webpack_require__(159);
	var CheckboxInputField = __webpack_require__(160);
	var CheckboxInputFields = __webpack_require__(161);
	...
	var SurveyApp = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(CheckboxInputFields, {
	            questions: this.state.questions,
	            handleFieldChange: this.handleFieldChange });
	    },
	    handleFieldChange: function handleFieldChange(questionIndex, elementIndex, checked) {
	...
	var questions = [{ name: "fruits",
	    ...
	    values: [{ label: "Apples", value: "apples" }, { label: "Bananas", value: "bananas" }, { label: "Kiwi fruit", value: "kiwi" }]
	}, { name: "tvseries",
	    blurb: "What TV series do you watch?",
	    values: [{ label: "The Walking Dead", value: "walkingdead" }, { label: "Game of Thrones", value: "gameofthrones" }, { label: "Breaking Bad", value: "breakingbad" }, { label: "The X-Files", value: "xfiles" }]
	}, { name: "tvstreaming",
